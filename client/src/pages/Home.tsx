...
import { ArrowUpLeft, Brain, ChevronLeft, Flame, Gamepad2, LockKeyhole, Map, RotateCcw, ShieldCheck, ShoppingBag, Target, Trophy, Users, Zap } from "lucide-react";
  ...
  return (
    <NexusShell>
      <div className="home-page">
        ...
        <section className="section-block nexus-extensions"><div className="section-heading"><div><span className="eyebrow">03 / الامتدادات</span><h2>واصل الأثر مع الآخرين.</h2></div></div><div className="extension-links"><Link href="/community"><Users size={18} /><div><b>المجتمع الحي</b><span>غرف موثقة، بطولة وعصابات.</span></div><ArrowUpLeft size={16} /></Link><Link href="/arcade"><Gamepad2 size={18} /><div><b>صالة الآركيد</b><span>ثلاث تجارب ونتائج حسابية.</span></div><ArrowUpLeft size={16} /></Link><Link href="/shop"><ShoppingBag size={18} /><div><b>مختبر الذهب</b><span>محفظة داخلية ومكافآت اللعب.</span></div><ArrowUpLeft size={16} /></Link></div></section>

...
بعدها أحفظه في بيئة الخادم، ثم أختبر أن الخادم يرفض الرموز الخاطئة ولا يقبل إلا رمز هوية صادرًا من Google ومخصصًا لهذا العميل. يستقبل الخادم **ID token** عبر HTTPS ويتحقق منه على الخادم؛ لا يعتمد على ادعاء التطبيق بأن المستخدم سجّل دخوله.[4]
